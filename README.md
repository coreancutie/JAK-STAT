...
The Interleukin 6 (IL-6) Janus kinases/Signal Transducers and Activators of Transcription (JAK/STAT) pathway helps regulate the body’s inflammatory response through the differentiation of T-cells. When released by other immune cells, the IL-6 cytokine protein binds to T-cell surfaces and activates JAK/STAT proteins downstream inside the cell. The STAT proteins get phosphorylated when activated and turns transcription factors on and off inside the cell nucleus for functions related to immunity and cell growth.
